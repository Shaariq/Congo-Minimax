// This is part 2 of the congo-ai assignment
// It will focus on computing possible moves
...
int convertColumnBack(string column)
{
    if (column == "1") {
        return 0;
    } else if (column == "2") {
...
// this function computes the move for a white lion
// a white lion can move one square in any direction
// between c1, c3, e3 and e1
void computeWhiteLion(Lion lion, array<array<string, 7>, 7> board)
{
    // we need to check above, below, left and right
    // as well as the four corners
    // if blocked by a white piece, we cannot move there
    // if blocked by a black piece, we can move there

    // get lion position
    int row = convertRowBack(lion.getRow());

    int column = convertColumnBack(lion.getColumn());


    // check above
    if (column + 1 < 3 && board[column + 1][row] == " ") {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 3 && board[column + 1][row] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } 
    
    // check below
    if (column - 1 > -1 && board[column -1][row] == " ") {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    } else if (column - 1 > -1 && board[column - 1][row] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row) << convertColumn(column - 1) << endl;
    }

    // check left
    if (row - 1 > 1 && board[column][row - 1] == " ") {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    } else if (row - 1 > 1 && board[column][row - 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column) << endl;
    }

    // check right
    if (row + 1 < 5 && board[column][row + 1] == " ") {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    } else if (row + 1 < 5 && board[column][row + 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column) << endl;
    }

    // check diagonal up left
    if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == " ") {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row - 1 > 1 && board[column + 1][row - 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column + 1) << endl;
    }

    // check diagonal up right
    if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == " ") {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && row + 1 < 5 && board[column + 1][row + 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column + 1) << endl;
    }
    
    // check diagonal down left
    if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == " ") {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row - 1 > 1 && board[column - 1][row - 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row - 1) << convertColumn(column - 1) << endl;
    }

    // check diagonal down right
    if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == " ") {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackSuperPawnToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackGiraffeToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackMonkeyToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackElephantToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackLionToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column - 1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackCrocodileToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    } else if (column -1 > 1 && row + 1 < 5 && board[column - 1][row + 1] == blackZebraToken) {
        cout << "white lion can move to " << convertRow(row + 1) << convertColumn(column - 1) << endl;
    }

    // consuming a black lion
}

void computeBlackLion(Lion lion, array<array<string, 7>, 7> board)
{
    // check above
    if (column + 1 < 5 && board[column + 1][row] == " ") {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whitePawnToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteSuperPawnToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteGiraffeToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteMonkeyToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteElephantToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteLionToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteCrocodileToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    } else if (column + 1 < 5 && board[column + 1][row] == whiteZebraToken) {
        cout << "black lion can move to " << convertRow(row) << convertColumn(column + 1) << endl;
    }
}
...
{   
    Lion whiteLion;
    whiteLion.setRowColumn("e", "1");

    vector<string> fenStrings = readInput();
    computeWhiteLion(whiteLion, processFenString(fenStrings[0]));
